<template>
  <div class="box">
    <div class="cont">
      <div class="bgc" v-show="show" @click="hide">
        <img src="@/assets/imgs/957.png" />
      </div>
      <div class="bg"></div>
      <div class="fff">
        <div class="content">
          ...
          <ul class="ul">
            <li v-for="(item, index) in list" :key="index">
              <p>
                <b>{{ item.b }}</b>
                <span class="sp1">{{ item.te }}</span>
                <span class="sp2">{{ item.detail }}</span>
              </p>
            </li>
          </ul>
        </div>
        <div class="yq" @click="dian">
...
<script>
import Related from "@/components/Person/Related";
...
export default {
  ...
  data() {
    return {
      show: false,
      list: [
        { b: "0", te: "我的特色课", detail: "已购特色课程的学习" },
        { b: "0", te: "一对一辅导", detail: "我的一对一老师辅导" },
        { b: "0", te: "剩余学习币", detail: "查看剩余学习币" },
      ],
    };
  },
  mounted() {},
...
.box {
  ...
  .fff {
    ...
    .content {
      ...
      box-shadow: 1px 1px 5px 0 rgb(228, 228, 228);
    }
  }
  #uu {
    width: 100%;
